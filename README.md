...
greed-strategy  SFP反转、趋势延续、日内扫单反转、爆量衰竭反转、相对弱势空头、统一仓位与风控
...
- `trend_continuation`：4h/12h 趋势一致，15m 回踩并重新延续后入场；0.6%权益风险，2R平40%，
  剩余仓位保本并跟踪趋势。
- `relative_weakness_short`：币种1h/4h分别落后BTC至少0.5%/1%，EMA空头排列，15m主动流
  不高于-5%，并新跌破前1h低点才做空；0.15%权益风险，名义仓位最多1倍权益，1R全平；
  浮盈达到0.4R后用0.15R距离跟踪，最多持仓30分钟。
- `intraday_sweep_reversal`：仅在4h非强趋势中运行。15m扫过近2小时局部高低点并收回，要求
  影线、1.6倍成交量和至少30%方向主动流，随后由1m突破拒绝K触发；多空对称，0.25%权益风险，
  结构止损，2R全平，最多持仓2小时。
- `burst_exhaustion`：30分钟涨跌至少2.5%且成交量达到近期2倍后，不追初始冲击；等待反方向
  5分钟K至少0.6%、主动成交流反转至少8%才反向入场。0.2%权益风险、名义价值最多1倍权益，
  结构止损、1R全平、最多持仓30分钟。

五条策略共享同一动态币池、最多3个持仓、4倍总名义敞口、2.5%日损停止和10%峰值回撤停止。
同一币种同一帧只允许一个解释；爆量衰竭反转拥有最高执行优先级，不会与趋势追单同时下单。日内扫单只在
|4h|<4%运行，趋势延续要求|4h|>=6%，避免同一行情的反向解释。

执行采用 maker-first：趋势单挂60秒GTX并每15秒向盘口调整，主单追价上限8bp；仍未成交时，
只有可执行价处于原信号20bp内才用原计划仓位的5%做市价探针。SFP挂60秒，未成交直接放弃；
相对弱势空头是时效性突破，按回测成本模型直接走taker。正常止盈全部使用
